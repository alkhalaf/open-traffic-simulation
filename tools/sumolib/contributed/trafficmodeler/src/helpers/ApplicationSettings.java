...
public class ApplicationSettings {
	public static String getDUARouterPath() {
		return Preferences.systemRoot().get("DUARouterPath", "");
	}

	public static void setDUARouterPath(String path) {
		Preferences.systemRoot().put("DUARouterPath", path);
	}

	public static String getNetConvertPath() {
		return Preferences.systemRoot().get("NetConvertPath", "");
	}

	public static void setNetConvertPath(String path) {
		Preferences.systemRoot().put("NetConvertPath", path);
	}
